...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:e64035bed1b9ce8ec415b74f4d2196a7dd003ca785b7bdcc5e3a41e42fb93989
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
In order to reduce the memory footprint of the validation step, you can
install the xmllint tool, which is part of the
``libxml2 <https://gitlab.gnome.org/GNOME/libxml2>``\ \_ package:
...
18.0.2.0.0 (2026-09-23)
-----------------------

Features
~~~~~~~~

- reduce memory footprint. Can be even more reduced by installing
  xmllint
  (`#445 <https://github.com/OCA/l10n-netherlands/issues/445>`__)
